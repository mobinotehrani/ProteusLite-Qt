...
const QList<ComponentDefinition> &ComponentCatalog::all()
{
    static const QList<ComponentDefinition> definitions{
        ...
        component("ADC", "ADC", "Converters / Advanced",
                  "Ideal N-bit analog-to-digital converter with reference pins and conversion delay.",
                  "4-bit"),
        component("DAC", "DAC", "Converters / Advanced",
                  "Ideal N-bit digital-to-analog converter with reference pins and conversion delay.",
                  "4-bit"),
        component("MCU", "Microcontroller", "Converters / Advanced",
                  "Educational MCU with Intel HEX loading, registers, RAM, decoder and three 8-bit ports.",
                  "firmware=empty"),
        component("EEPROM", "External EEPROM / RAM", "Converters / Advanced",
                  "Byte-addressable external memory with address, data and active-low control buses.",
                  "256 B"),
        component("LCD16x2", "LCD 16x2", "Converters / Advanced",
                  "Live 16x2 character LCD controlled through RS, RW, E and an 8-bit data bus.",
                  "Hello"),
        component("Keypad4x4", "Keypad 4x4", "Converters / Advanced",
                  "Interactive 4x4 matrix keypad for row and column scanning from MCU ports.",
                  "key=none"),
