...
نسخه موجود در شاخه `develop` شامل بخش‌های پیاده‌سازی‌شده تا پایان بخش نهم است. در این نسخه کاربر می‌تواند پروژه جدید بسازد، قطعات را از کتابخانه انتخاب کند، آن‌ها را روی بوم قرار دهد، مشخصاتشان را تغییر دهد، بین پایه‌ها سیم بکشد و نتیجه ساده شبیه‌سازی را مشاهده کند.
...
- پروب ولتاژ روی سیم، Junction و پایه در حالت Run و Pause
- ولت‌متر دوپایه با نمایش اختلاف ولتاژ و تشخیص نبود GND
- آمپرمتر سری با نمایش زنده جریان شاخه
- اسیلوسکوپ دوکاناله با CH1، CH2 و GND
- تنظیم مستقل Time/Div و Volts/Div برای نمودار اسیلوسکوپ
- توقف نمودار در Pause و پاک شدن آن در Stop
